      ...
      return s(t, [{
        ...
        value: function (t) {
          ...
          if (I.attr("id", "".concat(m, "-").concat(i)), I.attr("index", a), y && I.attr({
            ...
            }), "none" !== C.config.states.normal.filter.type) L.getDefaultFilter(I, a);
        ...
        value: function () {
          ...
          return t.globals.xLabelFormatter = function (t) {
            ...
            void 0 !== e.labels.formatter ? t.globals.yLabelFormatters[i] = e.labels.formatter : t.globals.yLabelFormatters[i] = function (s) {
              return d.isNumber(s) ? 0 !== t.globals.yValueDecimal ? s.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : t.globals.yValueDecimal) : t.globals.maxYArr[i] - t.globals.minYArr[i] < 10 ? s.toFixed(1) : s.toFixed(0) : s
            }
          }), t.globals
        }
      }, {
      ...
      return s(t, [{
        ...
        value: function (t, e, i, s) {
          var a, n = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
            ...
            c = o;
          return a = new D(this.ctx).xLabelFormat(l, o, c), void 0 !== h && (a = h(o, t[s], s)), e.length > 0 ? (i = e[s].position, a = e[s].value) : "datetime" === r.config.xaxis.type && void 0 === h && (a = ""), void 0 === a && (a = ""), (0 === (a = a.toString()).indexOf("NaN") || 0 === a.toLowerCase().indexOf("invalid") || a.toLowerCase().indexOf("infinity") >= 0 || n.indexOf(a) >= 0 && !r.config.xaxis.labels.showDuplicates) && (a = ""), {
            x: i,
            text: a
          }
        }
    ...
    _ = function () {
      ...
      return s(t, [{
        ...
        value: function (t, e, i) {
          ...
          var m = t;
          (o = []).push(m);
          for (var v = Math.abs(e - t) / a, y = 0; y <= a; y++) m += v, o.push(m);
        ...
        value: function (t, e, i) {
          t || (t = this);
          var s = t.w;
          if (s.globals.isMultipleYAxis) return e;
    ...
    mt = function (t) {
      ...
      return r(i, bt), s(i, [{
        ...
        value: function (t) {
          ...
          if (s.config.yaxis.forEach(function (t, e) {
            ...
            if (s.globals.zoomEnabled) {
              ...
              s.config.chart.group || (m[f] = f), a.ctx._updateOptions(m, !1, a.w.config.chart.animations.dynamicAnimation.enabled), "function" == typeof s.config.chart.events.zoomed && r.zoomCallback(p, f), s.globals.zoomed = !0
        ...
        value: function (t, e, i) {
          ...
          s.config.chart.group || (o[n] = n), this.ctx._updateOptions(o, !1, !1), "function" == typeof s.config.chart.events.scrolled && s.config.chart.events.scrolled(this.ctx, {
            xaxis: {
              min: e,
              max: i
            }
      ...
      return s(i, [{
        ...
        value: function (t) {
          var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            ...
            r = this.w;
          return t.series && (this.resetSeries(!1), t.series[0].data && (t.series = t.series.map(function (t, e) {
